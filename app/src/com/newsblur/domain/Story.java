...
public class Story implements Serializable {
    ...
    public ContentValues getValues() {
        ...
        values.put(DatabaseConstants.STORY_SHARED_DATE,
                sharedDate != null ? sharedDate.getTime() : new Date().getTime());
    ...
    public static Story fromCursor(final Cursor cursor) {
        ...
        story.sharedUserIds = TextUtils.split(
                cursor.getString(cursor.getColumnIndex(DatabaseConstants.STORY_SHARED_USER_IDS)), ",");
        story.friendUserIds = TextUtils.split(
                cursor.getString(cursor.getColumnIndex(DatabaseConstants.STORY_FRIEND_USER_IDS)), ",");
        story.publicUserIds = TextUtils.split(
                cursor.getString(cursor.getColumnIndex(DatabaseConstants.STORY_PUBLIC_USER_IDS)), ",");
        story.intelligence.intelligenceAuthors = cursor.getInt(cursor
                .getColumnIndex(DatabaseConstants.STORY_INTELLIGENCE_AUTHORS));
        story.intelligence.intelligenceFeed = cursor.getInt(cursor
                .getColumnIndex(DatabaseConstants.STORY_INTELLIGENCE_FEED));
        story.intelligence.intelligenceTags = cursor.getInt(cursor
                .getColumnIndex(DatabaseConstants.STORY_INTELLIGENCE_TAGS));
        story.intelligence.intelligenceTitle = cursor.getInt(cursor
                .getColumnIndex(DatabaseConstants.STORY_INTELLIGENCE_TITLE));
    ...
    public int getIntelligenceTotal() {
        return getIntelligenceTotal(intelligence.intelligenceTitle, intelligence.intelligenceAuthors,
                intelligence.intelligenceTags, intelligence.intelligenceFeed);
    }
    ...
    /**
     * Custom equality based on storyID/feedID equality so that a Set can
     * de-duplicate story objects.
     */
    @Override
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Story))
            return false;
        Story s = (Story) o;
        return ((this.id == null ? s.id == null : this.id.equals(s.id)) && (this.feedId == null ? s.feedId == null
                : this.feedId.equals(s.feedId)));
    }

    /**
     * Per the contract of Object, since we redefined equals(), we have to
     * redefine hashCode().
     */
    @Override
    public int hashCode() {
