...
public class UIHelper {
    ...
    int getArticleDownloadIndicatorDrawable(int downloaded, int downloadPref, Resources resources) {
        ...
        int backgroundResource = resources.getIdentifier(resourceName, "drawable", "com.newsrob.threetosix");
    ...
    public static void pauseWebViews(final Activity activity) {
        if (true)
            return;
        pauseWebViews(activity, true);
    }

    public static void resumeWebViews(final Activity activity) {
        if (true)
            return;
        pauseWebViews(activity, false);
    }

    private static void pauseWebViews(final Activity activity, final boolean pause) {
