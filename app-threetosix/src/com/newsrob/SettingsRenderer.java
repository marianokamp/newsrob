...
public class SettingsRenderer {
    ...
    public static StringBuilder renderSettings(EntryManager entryManager, StringBuilder sb) {
        ...
        sb.append("-- Configured Capacity: " + entryManager.getStorageCapacity() + "\n");
        ...
        if (NewsRob.isDebuggingEnabled(entryManager.getContext())) {
            ...
            try {
                ...
                sb.append("--   Article Unread Count:" + entryManager.getUnreadArticleCountExact() + "\n");
    ...
    private static String getProperty(final String name) {
        ...
        try {
            final Process process = Runtime.getRuntime().exec("getprop " + name);
            final BufferedReader br = new BufferedReader(new InputStreamReader(process.getInputStream()), 512);
            String line;
